...
class MoE(nn.Module):
    ...
    def __init__(self, input_size, output_size, num_experts, hidden_size, noisy_gating=True, k=4, loss_coefficient=1e-2):
    ...
    def forward(self, x, expert_specialization=False):
        """Args:
